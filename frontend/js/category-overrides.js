...
const COMBO_OVERRIDES = {
  ...
  concentration: [
    { label: 'Уровень концентрации рынка (HHI)', url: 'ihh-chart.html', parentCode: '3.18', hideCodes: ['3.17', '3.19'],
      series: [{ code: '3.18', label: 'Средний' }, { code: '3.19', label: 'Медианный' }] },
  ],
  apartments: [
